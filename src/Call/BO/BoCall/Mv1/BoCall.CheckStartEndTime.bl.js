...
// if stopTime is set  
if (me.getStopTimeEffective() !== Utils.getMinDate()) {
  ...
  if(me.getStartTimeEffectiveTimezoneOffset() != me.getStopTimeEffectiveTimezoneOffset()){
    ...
    if(currentOffset == me.getStartTimeEffectiveTimezoneOffset()){
      ...
      // correct stop time
      AppLog.info("Visit timestamp correction - current StopTimeEffective: " + me.getStopTimeEffective());
      ...
      AppLog.info("Visit timestamp correction - corrected StopTimeEffective:  " + me.getStopTimeEffective());
  
    }else if (currentOffset == me.getStopTimeEffectiveTimezoneOffset()){
      // correct start time
      AppLog.info("Visit timestamp correction - current StartTimeEffective: " + me.getStartTimeEffective());
      ...
      AppLog.info("Visit timestamp correction - corrected StartTimeEffective: " + me.getStartTimeEffective());
    }
  }
}
